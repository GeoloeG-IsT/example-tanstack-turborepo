...
| [agentuity-cli-cloud-sandbox-snapshot-generate](./agentuity-cli-cloud-sandbox-snapshot-generate) | `agentuity cloud sandbox snapshot generate` | Generate a template snapshot build file |
